...
$OutlinePath = GUICtrlCreateInput("D:\Specimen\Matt_Roy\TG6_April\Results_Outlines", 16, 176, 353, 21)
$Prefix= GUICtrlCreateInput("TG6_3shot", 16, 272, 145, 21)
$Path1 = GUICtrlCreateLabel("Program path", 16, 104, 67, 17)
$ProgramPath=GUICtrlCreateInput("D:\Specimen\Matt_Roy\TG6_April\Programs", 18, 128, 353, 21)
$Label2 = GUICtrlCreateLabel("User-defined results && outlines path", 16, 152, 175, 17)
$Iter = GUICtrlCreateInput("9", 184, 272, 81, 21)
...
$WorkingDirectory = GUICtrlCreateInput("D:\Specimen\Matt_Roy\TG6_April", 18, 76, 353, 21)
$Label5 = GUICtrlCreateLabel("Full path to re-orientation points *.txt file", 16, 208, 188, 17)
$RelocatePath = GUICtrlCreateInput("D:\Specimen\Matt_Roy\TG6_April\Results_Outlines\relocation1.txt", 16, 232, 353, 21)
$Label6 = GUICtrlCreateLabel("Refining points", 288, 256, 74, 17)
$nRp = GUICtrlCreateInput("75", 288, 272, 81, 21)
